...
namespace Webflow.Application.Services.StudentsService.Implementations
{
    public partial class StudentsService : IStudentsService
    {
        ...
        public async Task<BaseResponse<StudentView>> UpdateStudent(Guid? id, UpdateStudentRequest request, CancellationToken cancellationToken)
        {
           ...
           if (id == null)
            ...
            response.Data = mapper.Map<StudentView>(student);
            return response;
        }
    }
}
