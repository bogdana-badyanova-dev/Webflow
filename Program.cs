...
using Webflow.Application.Services.CourseResultsService.Implementations;
using Webflow.Application.Services.CourseResultsService.Interfaces;
using Webflow.Application.Services.CoursesService.Implementations;
...
using Webflow.Application.Services.GroupsService.Implementations;
...
using Webflow.Infrastructure.Repositories.CourseResultsRepository.Implementations;
using Webflow.Infrastructure.Repositories.CourseResultsRepository.Interfaces;
using Webflow.Infrastructure.Repositories.CoursesRepository.Implementations;
...
using Webflow.Infrastructure.Repositories.SkillsRepository.Implementations;
...
namespace Webflow
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<ICourseResultsRepository, CourseResultsRepository>();
            builder.Services.AddScoped<ICourseResultsService, CourseResultsService>();
