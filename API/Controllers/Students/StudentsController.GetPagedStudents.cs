...
namespace Webflow.API.Controllers.Students
{
    public partial class StudentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<BaseResponse<PaginatedResponse<StudentView>>>> GetPagedStudent([FromBody] GetPagedStudentsRequest request, CancellationToken cancellationToken)
        {
